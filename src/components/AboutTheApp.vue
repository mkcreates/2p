...
<template>
    <div class="bg-black/30 rounded-2xl overflow-hidden">
        <div class="bg-[url(../img/track-bg.svg)] bg-cover bg-center text-white/80 text-sm p-6">
        <h1 class="bg-clip-text text-transparent bg-gradient-to-br from-[--main-color-dark] to-white font-semibold text-base mb-2">Welcome</h1>
